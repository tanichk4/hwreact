...
const Task6 = () => {
  ...
  return (
    <div>
      ...
      <button onClick={handleClick}>Вернуться на предыдущую страницу</button>
    </div>
  );
  ...
  /* <div>
            ...
            <div>
              <Link to="/tasksdescription">Tasks Descriprion</Link>
            </div>
            <div>
...
//   return (
//     <div>
//       <div>Це вирішення 4-го  домашнього завдання від Тетяни.</div>
//       <div>
